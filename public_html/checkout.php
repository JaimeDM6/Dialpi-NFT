...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['seleccionarDireccion'])) {
    $_SESSION['checkout'] = [
        'direccion' => true,
        'metodo-pago' => true,
    ];
            ...
            <?php
                ...
                switch ($parametro) {
                    case 'invitado':
                        ...
                        break;
                    case 'direccion':
                        if (isset($_SESSION['checkout']['direccion'])) {
                            if (isset($_SESSION['cart'])) {
                                if (isset($_SESSION['usuario'])) {
                                    $idUsuario = $_SESSION['usuario']['id'];
                                    ...
                                    ?>
                                        ...
                                        <div class="boton-derecha">
                                            <button class="siguiente" id="seleccionar">Seleccionar</button>
                                        </div>
                                    <?php
                                    } else {
                                    ?>
                    ...
                    case 'direccion-edit':
                        ...
                        break;
                    case 'metodo-pago':
                        if (isset($_SESSION['checkout']['metodo-pago'])) {
                            ...
                            if (isset($_SESSION['usuario']) || isset($_SESSION['invitado'])) {
                                ...
                                <div class="cuenta">
                                    <div class="cuenta-izq">
                                        <form method="POST" action="/signin" class="login-form checkout-login">
        ...
        $(document).ready(function(){
            ...
            $('#seleccionar').on('click', function(e) {
                ...
                $.ajax({
                    url: '/checkout?direccion',
                    method: 'POST',
                    data: { seleccionarDireccion: true },
                    dataType: 'json',
                    success: function(response) {
                        if (response.success) {
                            window.location.href = '/checkout?metodo-pago';
                        }
                    }
                });
            });
