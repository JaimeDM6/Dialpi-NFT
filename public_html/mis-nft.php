                ...
                <div class="mis-nft-grid">
                    <?php foreach ($nfts as $nft): ?>
                        <div class="nft">
                            ...
                            <a href="certificado.php?id=<?php echo $nft['id_nft']; ?>" target="_blank">Descargar Certificado</a>
                            <a href="vender-nft.php?id=<?php echo $nft['id_nft']; ?>" class="boton-vender">Vender NFT</a>
                        </div>
                    <?php endforeach; ?>
                </div>
            <?php endif; ?>
