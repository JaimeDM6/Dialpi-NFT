    ...
    <main>
        <div class="container">
            <div class="menu-columna">
                <ul>
                    <li class="<?= $parametro == 'perfil' ? 'active' : '' ?>"><a href="/cuenta?perfil">Perfil</a></li>
                    <li class="<?= $parametro == 'direccion' ? 'active' : '' ?>"><a href="/cuenta?direccion">Dirección</a></li>
                ...
                switch ($parametro) {
                    case 'perfil':
                        $id_usuario = $_SESSION['usuario']['id'];
                            ...
                            $consulta = "SELECT dni_usuario, nombre_usuario, apellidos_usuario, email_usuario, telefono_usuario, ruta_perfil 
                                         FROM Usuarios WHERE id_usuario = ?";
                            
                            $sentencia = $conexion->prepare($consulta);
                            $sentencia->bind_param("i", $id_usuario);
                            $sentencia->execute();
                            $sentencia->bind_result($dni, $nombre, $apellidos, $correo, $telefono, $ruta_perfil);
                            $sentencia->fetch();
                            $sentencia->close();
