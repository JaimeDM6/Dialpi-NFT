...
$pdf->SetTitle('Cenrtificado de Autenticidad NFT');
...
$certificate = '/var/www/nftdialpi.ddns.net/tcpdf.crt';
...
$pdf->setSignature($certificate, $certificate, '2ASIR_Grupo3', '', 2, $info);
