                ...
                if ($stmt = $conexion->prepare($query)) {
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $thumbnailPath = 'img/colecciones/' . $nombre_coleccion . '/' . htmlspecialchars($row["nombre_nft"]) . '_thumb.png';
                            echo '<img src="' . $thumbnailPath . '" alt="' . htmlspecialchars($row["nombre_nft"]) . '">';
